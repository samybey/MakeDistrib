...
Main::Main(CkArgMsg* msg) {
	...
	CProxy_Node helloo = CProxy_Node::ckNew("hello.o", {},
		"gcc -o hello/hello.o -c hello/hello.c -W -Wall -ansi -pedantic");

	CProxy_Node maino = CProxy_Node::ckNew("main.o", {},
		"gcc -o hello/main.o -c hello/main.c -W -Wall -ansi -pedantic");
