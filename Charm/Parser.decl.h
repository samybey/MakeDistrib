...
class CkIndex_Parser:public CkIndex_Chare{
  public:
    ...
    /* DECLS: sync std::vector<StringNode > firstPass(char* inputFile);
     */
    // Entry point registration at startup
    ...
    inline static int idx_firstPass(std::vector<StringNode > (Parser::*)(char* inputFile) ) {
 ...
 */
    ...
    std::vector<StringNode > firstPass(char* inputFile, const CkEntryOptions *impl_e_opts=NULL);
